...
function Section({ id, eyebrow, title, description, children }: SectionProps) {
  ...
  return (
    <section id={id} className="docs-section stack container-content" aria-labelledby={titleId}>
      <header className="docs-section-header stack">
...
export default function ComponentLibraryPage() {
  return (
    <div className="theme-dark docs-page">
      <style>{libraryCss}</style>
      <LibraryHeader />

      <main className="docs-main">
        <section id="overview" className="hero docs-hero container-content docs-boundary" aria-labelledby="overview-title">
          <div className="docs-hero-copy stack">
            <span className="eyebrow">Component library</span>
            <h1 className="hero-title" id="overview-title">
              Build with confidence using llamojha.css
            </h1>
        ...
        <div className="docs-shell docs-boundary">
          <aside className="docs-sidebar" aria-label="Component library sections">
            <nav>
              {sectionLinks.map(({ href, label }) => (
                <a key={href} className="docs-sidebar-link" href={href}>
                  {label}
                </a>
              ))}
            </nav>
